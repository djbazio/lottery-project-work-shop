...
@section('content')
    ...
    <script>
        ...
        function createPost() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let _url = "{{ route('admin.data.customer.store') }}";
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            if (id != "") {
                                ...
                                $('#table_crud tbody').prepend("<tr align='center' id='row_" + res.data.id + "'" +
                                    ">" +
                                    ...
                                    "<td class='align-middle'>" + res.data.fname + " " + res.data.lname + "</td>" +
        ...
        function editPost(event) {
            ...
            let _url = "/admin/api/getCustomerData/" + id;
            let _token = $('meta[name="csrf-token"]').attr('content');
            clearTextModalError();
        ...
        function deletePost(event) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var id = $(event).data("id");
                    let _url = "/admin/data/delete/customer/" + id;
                    let _token = $('meta[name="csrf-token"]').attr('content');
    ...
    <script>
        ...
        function select_delete() {
            var arr = [];
            var _url = "{{ route('admin.data.delete.all_customer') }}";
            let _token = $('meta[name="csrf-token"]').attr('content');
                            ...
                            <table class="table table-head-fixed text-nowrap" id="table_crud">
                                ...
                                <tbody>
                                    @foreach ($customers as $customer)
                                        <tr id="row_{{ $customer->id }}" align="center">
                                            ...
                                            <td class="align-middle">{{ $customer->fname }} {{ $customer->lname }}</td>
                                            <td class="align-middle">{{ $customer->tel }}</td>
                                            <td class="align-middle">{{ $customer->address }}</td>
                                            <td class="align-middle">{{ $customer->username }}</td>
                                            <td class="align-middle">{{ $customer->money }} บาท</td>
